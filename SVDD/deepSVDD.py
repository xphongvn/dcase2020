...
from SVDD.networks.main import build_network, build_autoencoder
from SVDD.optim.deepSVDD_trainer import DeepSVDDTrainer
from SVDD.optim.ae_trainer import AETrainer
...
class DeepSVDD(object):
    ...
    def set_network(self, net_name, inputDim=None):
        """Builds the neural network \phi."""
        self.net_name = net_name
        self.net = build_network(net_name, inputDim)
    ...
    def pretrain(self, dataset: BaseADDataset, optimizer_name: str = 'adam', lr: float = 0.001, n_epochs: int = 100,
                 lr_milestones: tuple = (), batch_size: int = 128, weight_decay: float = 1e-6, device: str = 'cuda',
                 n_jobs_dataloader: int = 0, inputDim = None):
        """Pretrains the weights for the Deep SVDD network \phi via autoencoder."""

        self.ae_net = build_autoencoder(self.net_name, inputDim)
